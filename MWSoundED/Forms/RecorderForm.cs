...
namespace MWSoundED
{
    ...
    {
        private string dirName = string.Format($@"{Environment.CurrentDirectory}\Wav\");

        private string wavFileName = string.Empty;

        private string outWaveFileName;

        public string OutWaveFileName { get { return outWaveFileName; } }
